function create_container {
    ...
    sudo  docker cp /tmp/pfsense.yaml 29a09dba0e86:/etc/datadog-agent/conf.d/snmp.d
    sudo  docker cp /tmp/freenas.yaml 29a09dba0e86:/etc/datadog-agent/conf.d/snmp.d
