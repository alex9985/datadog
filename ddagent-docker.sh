...
sudo  docker cp /etc/datadog-agent/conf.d/snmp.d/pfsense.yaml $image:/etc/datadog-agent/conf.d/snmp.d
sudo  docker cp /etc/datadog-agent/conf.d/snmp.d/freenas.yaml $image:/etc/datadog-agent/conf.d/snmp.d
